...
// rdar:/
    ...
    int32_t insert(int32_t index, const UnicodeString &unistr, Field field, bool addBidiIsolates, UErrorCode &status);

    inline int32_t insert(int32_t index, const UnicodeString &unistr, int32_t start, int32_t end, Field field,
                          UErrorCode &status) {
