 ...
 *
 * <p>This class was not intended to be subclassed. The subclassing interface to
 * RulesBasedBreakIterator is not part of the ICU API, and may not remain stable.</p>
 *
 * <p>However, the ICU 57 version <em>was<em> subclassed for the Apple RuleBasedTokenizer.
 * So this legacy version of RuleBasedBreakIterator is preserved for that usage,
 * since versions of RuleBasedBreakIterator in ICU 58 and later broke that
 * subclassing (in ICU 58 it just by changing the access to certain internal fields,
 * but in ICU 60 RuleBasedBreakIterator was completely rewritten).</p>
 */
class U_COMMON_API RuleBasedBreakIterator57 /*U_FINAL*/ : public BreakIterator {
...
protected:
    ...
    */
     ...
     * RuleBasedBreakIterator57(RBBIDataHeader57*, EDontAdopt, UErrorCode &);
     * which does not adopt the memory indicated by the RBBIDataHeader57*
     * parameter.
     *
     * @internal, used by rbtok.cpp, urbtok57.cpp
     */
    enum EDontAdopt {
        kDontAdopt
    };
     ...
     *             free it when done.
     * @internal, used by rbtok.cpp
     */
    RuleBasedBreakIterator57(RBBIDataHeader57* data, UErrorCode &status);
     ...
     * @internal, used by rbtok.cpp
     */
    RuleBasedBreakIterator57(const RBBIDataHeader57* data, enum EDontAdopt dontAdopt, UErrorCode &status);


    friend class RBBIRuleBuilder57;
    /** @internal */
...
public:
     ...
     * @param that The RuleBasedBreakIterator57 passed to be copied
     * @internal
     */
    RuleBasedBreakIterator57(const RuleBasedBreakIterator57& that);

    /**
     * Construct a RuleBasedBreakIterator57 from a set of rules supplied as a string.
     ...
     * @internal, used by rbtok.cpp
     */
    RuleBasedBreakIterator57( const UnicodeString    &rules,
...
// not used by rbtok.cpp
    /**
     * Contruct a RuleBasedBreakIterator57 from a set of precompiled binary rules.
     ...
     * @internal
     */
    RuleBasedBreakIterator57(const uint8_t *compiledRules,
                           uint32_t       ruleLength,
                           UErrorCode    &status);
     ...
     * @internal
     */
    RuleBasedBreakIterator57(UDataMemory* image, UErrorCode &status);
#endif
     ...
     *  @internal
     */
    virtual ~RuleBasedBreakIterator57();

    /**
     * Assignment operator.  Sets this iterator to have the same behavior,
     * and iterate over the same text, as the one passed in.
     * @param that The RuleBasedBreakItertor passed in
     * @return the newly created RuleBasedBreakIterator57
     *  @internal
     */
     ...
     * @return a newly-constructed RuleBasedBreakIterator57
     * @internal
     */
...
// not used by rbtok.cpp
     ...
     * @internal, inherited from BreakIterator
     */
    ...
    */
     ...
     * @internal, inherited from BreakIterator
     */
    virtual RuleBasedBreakIterator57 &refreshInputText(UText *input, UErrorCode &status);
...
private:
     ...
     * of buildBackwardsStateTable() in RuleBasedBreakIterator57.Builder.)
