...
// rdar://104877633 #381 add locales mid, mic, ber_Tfng, ber_Latn, nqo, nnp,rej, hmn, pqm
    ...
    "chr", "chy", "cic", "ckb", "co",  "cop", "cps", "cr",  "crh",
    "cs",  "csb", "cu",  "cv",  "cy",
...
// rdar://104877633 #381 add locales mid, mic, ber_Tfng, ber_Latn, nqo, nnp,rej, hmn, pqm	
    ...
    "chr", "chy", "cic", "ckb", "cos", "cop", "cps", "cre", "crh",
    "ces", "csb", "chu", "chv", "cym",
...
// rdar://23673316 1cb3008756.. Update uloc COUNTRIES[_3] lists to include all valid CLDR regular regions
/*  "CH",  "CI",  "CK",  "CL",  "CM",  "CN",  "CO",  "CP",  "CQ",  "CR",     */
    "CHE", "CIV", "COK", "CHL", "CMR", "CHN", "COL", "CPT", "CRQ", "CRI",
#else
/*  "CH",  "CI",  "CK",  "CL",  "CM",  "CN",  "CO",  "CQ",  "CR",     */
...
// Apple ICU restores (in modified form) these first 3 mappings to "en_US_POSIX" deleted in OSICU 64 (from "", "c", "posix").
// rdar://114361374 re-removes these mappings
#endif // APPLE_ICU_CHANGES
...
// TODO (rtg): Use unit tests to figure out how to reimplement this functionality on the rewritten OSICU code!
#if APPLE_ICU_CHANGES
// rdar://45116092 commit 044f2039da.., Merge ICU 64rc3: Undo parts of ICU-20273,20447 (PR-455,472) that cause compatibility probs (mapping root/und to "")
    if(i>0) {
                  ...
                  UErrorCode* err)
{
    ...
    Locale loc = Locale::createCanonical(localeID);
    const char* canonicalName = loc.getName();
    int32_t nameLen = uprv_strlen(canonicalName);
