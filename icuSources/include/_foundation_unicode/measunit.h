...
// rdar://
   ...
   /**
     * [Apple-specific] Create a MeasureUnit instance based on a UAMeasureUnit value.
     * @param uaMeasureUnit The UAMeasureUnit to base the new object on.
     * @param status Error code.
     * @return A newly-created MeasureUnit for the unit specified by uaMeasureUnit.
     */
    static MeasureUnit* createFromUAMeasureUnit(UAMeasureUnit uaMeasureUnit, UErrorCode* status);
...
#ifndef U_HIDE_DRAFT_API
    /**
     * [Apple-specific] Returns the UAMeasureUnit value corresponding to this object's unit.
     */
    UAMeasureUnit getUAMeasureUnit() const;
    
    /**
     * [Apple-specific] Fills in the provided array with one or more UAMeasureUnits corresponding to this MeasureUnit.
     * @param units A pointer to an array to fill with the results
     * @param unitsCapacity The number of UAMeasureUnits the result array can hold.
     * @param status The error code.
     * @return The actual number of single units in this MeasureUnit.
     */
    int32_t getUAMeasureUnits(UAMeasureUnit* units, int32_t unitsCapacity, UErrorCode& status) const;
#endif // U_HIDE_DRAFT_API
#endif  // APPLE_ICU_CHANGES
